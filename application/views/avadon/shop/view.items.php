			...
			<div class="row">
				...
				<?php
					if(isset($error)){
						...
						if(isset($items) && !empty($items)){
							echo '<div class="itemsBlock flex-c-c">';
							foreach($items as $item){
								echo '<div class="item">
										<!--<div class="item-corner new-item"><span>New</span></div>-->
										<div class="item-img flex-c-c" id="shop_item_image_' . $item['id'] . '" data-name="' . $item['name'] . '" data-info="' . $item['class'] . '">
											' . $item['image'] . '
										</div>
										<div class="item-name" id="shop_item_title_' . $item['id'] . '" data-name="' . $item['name'] . '" data-info="' . $item['class'] . '">
											' . $item['name'] . '
										</div>
										...
										<div class="item-buy" id="shop_item_buy_' . $item['id'] . '" data-name="' . $item['name'] . '">
											Buy Item
										</div>
									</div>';
							}
				...
				<script type="text/javascript">
					$(document).ready(function () {
						$('div[id^="shop_item_title_"], div[id^="shop_item_image_"]').each(function () {
							App.initializeTooltip($(this), false);
						});
						$('div[id^="shop_item_buy_"]').on('click', function (e) {
							e.preventDefault();
