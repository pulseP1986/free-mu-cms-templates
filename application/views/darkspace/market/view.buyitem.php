                    ...
                    if(!isset($error)):
                        ...
                        <form method="POST" action="" id="buy_item" name="buy_item">
                            ...
                            <table class="ranking-table">
								...
								?>
								<tr>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('Can purchase on'); ?>
                                        :
                                    </td>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo date(DATETIME_FORMAT, strtotime($this->Mmarket->item_info['add_date']) + $availableOn); ?></td>
                                </tr>
								<?php
									}
								} 
                                ...
                                <?php if($this->Mmarket->item_info['password'] != null && $this->Mmarket->item_info['password'] != ''){ ?>
                                <tr>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('Password'); ?></td>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><input type="text" name="password" id="password" value="" placeholder="<?php echo __('Item password');?>" /></td>
                                </tr>
                                <?php } ?>
                                </tbody>
                            </table>
