                                    ...
                                    if($char_list):
                                        ...
                                        foreach($char_list as $char):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="cname-<?php echo bin2hex($char['name']); ?>" name="charname" value="<?php echo $char['name']; ?>" tabindex="<?php echo $i; ?>"/> <button class="custom_button" id="charname-<?php echo bin2hex($char['name']); ?>"><?php echo __('Change Name'); ?></button>
                                                </td>
                                            </tr>
                                        <?php
                                        endforeach;
