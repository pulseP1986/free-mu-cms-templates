						...
						<div class="form-group">
							...
							<div>
								<select name="server" id="server" class="form-control validate[required]">
									...
									<?php foreach($this->website->server_list() as $key => $serverr){ ?>
											<option value="<?php echo $key; ?>" <?php if(isset($server) && $server == $key){ echo 'selected'; } ?>><?php echo $serverr['title']; ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
