					...
					<div class="mb-5">
						...
						<?php if(isset($drop_data)){ ?>
							...
							<div class="panel panel-default">
								<div class="panel-heading"><a class="red-text" style="text-decoration: underline !important;" href="<?php echo $this->config->base_url;?>drop/location/<?php echo urlencode($this->website->get_map_name($key));?>"><?php echo $this->website->get_map_name($key);?></a></div>
