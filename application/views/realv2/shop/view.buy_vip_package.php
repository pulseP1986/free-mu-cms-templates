		...
		<div class="vs-blog mt-15">
			<div class="blog-meta has-border bg-major-black">
				<div class="blog-title text-white font-theme h4 mt-25-sm mb-5-off">
					<h2><?php if(isset($vip_data['package_title'])){ echo $vip_data['package_title']; } else{ echo 'Undefined'; } ?></h2>
				</div>
			</div>
							...
							<?php } else{ ?>
								...
								<form method="POST" action="" id="buy_vip">
									...
									<div class="form-group">
										<div class="d-flex justify-content-center align-items-center"><button type="submit" class="vs-btn gradient-btn h4" id="buy_vip" name="buy_vip" value="buy_vip"><?php echo __('Buy Vip'); ?></button></div>
									</div>
								</form>
							<?php } ?>
						</div>
