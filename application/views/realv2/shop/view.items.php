			...
			<div class="row">
				...
				<?php
					if(isset($error)){
							...
							foreach($items as $item){
								echo '<li class="shop-product-list-item flex-c-c">
										...
										<div class="detail">
											...
											<a class="item-buy vs-btn gradient-btn h4 btn-block" id="shop_item_buy_' . $item['id'] . '" data-name="' . $item['name'] . '">
												'.__('Buy Item').'
											</a>
											</div>
										</div>
						...
						if(isset($pagination)){
							echo '<div class="row mb-4"><div class="col-lg-12"><div class="d-flex justify-content-center align-items-center">'.$pagination.'</div></div></div>';
						}
					}
				?>
