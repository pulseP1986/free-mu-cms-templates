			...
			<div class="row">
				<div class="col-lg-12">     
					<h2 class="title">
						...
						<div class="float-right"><a class="vs-btn gradient-btn h4" href="<?php echo $this->config->base_url; ?>support/my-tickets"><?php echo __('View My Tickets'); ?></a></div>
					</h2>
				</div>	
			</div>	
			<div class="row">
				<div class="col-lg-12">   
					...
					<form method="post" action="<?php echo $this->config->base_url; ?>support" id="support_form" class="mb-5" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" class="form-control bg-light-dark text-white validate[required,minSize[3],maxSize[50]]" name="title" id="title" value="">
						</div>
						<div class="form-group">
							<label class="control-label"><?php echo __('Department'); ?></label>
							<div>
								<select name="department" id="department" class="form-control bg-light-dark text-white has-border py-18 register validate[required] " title="<?php echo __('Select Department'); ?>">
									<?php
						...
						<div class="form-group">
							...
							<div>
								<select name="priority" id="priority" class="form-control bg-light-dark text-white has-border py-18 register validate[required] " title="<?php echo __('Select Priority'); ?>">
						...
						<div class="form-group">
							...
							<div>
								<select name="character" id="character" class="form-control bg-light-dark text-white has-border py-18 register validate[required]" title="<?php echo __('Select Character'); ?>">
									<?php
									if($char_list){
						...
						<div class="form-group">
							<div class="d-flex justify-content-center align-items-center"><button type="submit" name="submit_ticket" class="vs-btn gradient-btn h4"><?php echo __('Submit'); ?></button></div>
						</div>
					</form>
					<script>
