                                    ...
                                    <?php if(!$hidden){ ?>		
                                        <div style="width: 100%;text-align: center;margin-top:10px;">
                                            ...
                                            <div id="inventoryc">
												...
												<?php if($equipment[0] != 0){ ?><div id="in_weapon" data-info='<?php echo $equipment[0]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[0]['item_id'], $equipment[0]['item_cat'], $equipment[0]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                        
												<?php if($equipment[1] != 0){ ?><div id="in_shield" data-info='<?php echo $equipment[1]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[1]['item_id'], $equipment[1]['item_cat'], $equipment[1]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                                
												<?php if($equipment[2] != 0){ ?><div id="in_helm" data-info='<?php echo $equipment[2]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[2]['item_id'], $equipment[2]['item_cat'], $equipment[2]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                               
												<?php if($equipment[3] != 0){ ?><div id="in_armor" data-info='<?php echo $equipment[3]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[3]['item_id'], $equipment[3]['item_cat'], $equipment[3]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                             
												<?php if($equipment[4] != 0){ ?><div id="in_pants" data-info='<?php echo $equipment[4]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[4]['item_id'], $equipment[4]['item_cat'], $equipment[4]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                                
												<?php if($equipment[5] != 0){ ?><div id="in_gloves" data-info='<?php echo $equipment[5]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[5]['item_id'], $equipment[5]['item_cat'], $equipment[5]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                             
												<?php if($equipment[6] != 0){ ?><div id="in_boots" data-info='<?php echo $equipment[6]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[6]['item_id'], $equipment[6]['item_cat'], $equipment[6]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>        
												<?php if($equipment[7] != 0){ ?><div id="in_wings" data-info='<?php echo $equipment[7]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[7]['item_id'], $equipment[7]['item_cat'], $equipment[7]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>      
												<?php if($equipment[9] != 0){ ?><div id="in_pendant" data-info='<?php echo $equipment[9]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[9]['item_id'], $equipment[9]['item_cat'], $equipment[9]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>                            
												<?php if($equipment[10] != 0){ ?><div id="in_ring1" data-info='<?php echo $equipment[10]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[10]['item_id'], $equipment[10]['item_cat'], $equipment[10]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>          
												<?php if($equipment[11] != 0){ ?><div id="in_ring2" data-info='<?php echo $equipment[11]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[11]['item_id'], $equipment[11]['item_cat'], $equipment[11]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>      
												<?php if(isset($equipment[12]) && $equipment[12] != 0){ ?><div id="in_pentagram" data-info='<?php echo $equipment[12]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[12]['item_id'], $equipment[12]['item_cat'], $equipment[12]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>    
												<?php if(isset($equipment[13]) && $equipment[13] != 0){ ?><div id="in_ear1" data-info='<?php echo $equipment[13]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[13]['item_id'], $equipment[13]['item_cat'], $equipment[13]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>       
												<?php if(isset($equipment[14]) && $equipment[14] != 0){ ?><div id="in_ear2" data-info='<?php echo $equipment[14]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[14]['item_id'], $equipment[14]['item_cat'], $equipment[14]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>        
												<?php if($equipment[8] != 0){ ?><div id="in_zoo" data-info='<?php echo $equipment[8]['item_info']; ?>' style="background: url(<?php echo $this->itemimage->load($equipment[8]['item_id'], $equipment[8]['item_cat'], $equipment[8]['level'], 0); ?>) no-repeat center center;background-size:contain;"></div><?php } ?>        			
											</div> 
											<?php } else { ?>
											<div id="inventory"
                                                ...
                                                <?php if($equipment[7] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[7]['item_info']; ?>' id="wings"
                                                ...
                                                <?php if($equipment[2] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[2]['item_info']; ?>' id="helm"
                                                ...
                                                <?php if($equipment[9] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[9]['item_info']; ?>' id="pendant"
                                                ...
                                                <?php if($equipment[0] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[0]['item_info']; ?>' id="sword"
                                                ...
                                                <?php if($equipment[1] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[1]['item_info']; ?>' id="shield"
                                                ...
                                                <?php if($equipment[3] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[3]['item_info']; ?>' id="armor"
                                                ...
                                                <?php if($equipment[4] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[4]['item_info']; ?>' id="pants"
                                                ...
                                                <?php if($equipment[5] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[5]['item_info']; ?>' id="gloves"
                                                ...
                                                <?php if($equipment[6] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[6]['item_info']; ?>' id="boots"
                                                ...
                                                <?php if($equipment[10] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[10]['item_info']; ?>' id="ring_left"
                                                ...
                                                <?php if($equipment[11] != 0){ ?>
                                                    <div data-info='<?php echo $equipment[11]['item_info']; ?>'
                                                         id="ring_right"
