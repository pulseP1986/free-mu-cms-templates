					...
					<div class="dmn-sidebar-box">
						...
						<form method="post" action="">
							...
							<?php if(defined('MU_VERSION') && MU_VERSION >= 13){ ?>
								<input type="radio" name="class" value="ik" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'ik'){ echo 'checked="checked"'; } ?>/> <?php echo __('Ilussion Knight');?><br/>
							<?php } ?>
							...
							?>
								<tr style="background-color:<?php echo $color; ?>;">
									...
									<td style="background-color:<?php echo $color; ?>;">
										<span id="market_item_<?php echo $item['pos']; ?>" data-info='<?php echo $item['item_info']; ?>'><a href="<?php echo $this->config->base_url; ?>market/buy/<?php echo $item['id']; ?>"><?php echo $item['name']; ?></a></span>
									</td>
