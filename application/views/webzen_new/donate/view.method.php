			...
			<div class="row">
				<div class="col-12">     
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-2 ml-1 mr-1 mb-1"><a href="<?php echo $this->config->base_url; ?>donate/paypal<?php echo $pass;?>" class="btn btn-primary dmn-donate-button" role="button"><?php echo __('PayPal'); ?></a></div>
						<?php } ?>
						...
						if(!empty($plugins)):
							foreach($plugins AS $plugin):
								if($plugin['installed'] == 1 && $plugin['donation_panel_item'] == 1):
									$is_any = true;
									echo '<div class="col-2 ml-1 mr-1 mb-1"><a href="' . $plugin['module_url'] . $pass . '" class="btn btn-primary dmn-donate-button" role="button">' . $plugin['about']['name'] . '</a></div>';
								endif;
							endforeach;
						endif;
						?>
