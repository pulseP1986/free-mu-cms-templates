	...
	<div class="dmn-page-box">
		...
		<div class="dmn-page-content">
			...
			<div id="top_list" class="rankings">
				<div class="row">
					<div class="col-12">  
						<div id="rankings_select_<?php echo $server; ?>" class="text-center mt-2">
							<?php if(isset($config['player']['count']) && $config['player']['count'] > 0): ?>
							...
							<?php
								...
								if(isset($config['active']) && $config['active'] == 1):
									?>
									<a href="<?php echo $this->config->base_url; ?>rankings/online-players/<?php echo $server; ?>" class="btn btn-xs btn-primary"><?php echo __('Online Players'); ?></a>
								<?php
								endif;
							?>
							<?php
								...
								if(!empty($plugins)):
									foreach($plugins AS $plugin):
										if($plugin['installed'] == 1 && isset($plugin['rankings_panel_item']) && $plugin['rankings_panel_item'] == 1):
											?>
											<a href="<?php echo $plugin['module_url']; ?>" class="btn btn-xs btn-primary"><?php echo $plugin['about']['name']; ?></a>
										<?php
										endif;
									endforeach;
								endif;
